...
{lang_get var="labels"
          s="current_test_plan,ok,testplan_role,msg_no_rights_for_tp,
             ...
             href_exec_ro_access,href_automation_test"}
  ...
  {if $display_right_block_2}
	...
	{if $gui->grants.testplan_execute == "yes" || 
        ...
        {if $gui->grants.testplan_execute == "yes"}
		  ...
		  <!-- <a href="{$gui->launcher}?feature=executeTest" class="list-group-item" style="{$aStyle}">{$gui->launcher}</a> -->
		  <a href="{$gui->launcher}?feature=automationTest" class="list-group-item" style="{$aStyle}">{$labels.href_automation_test}</a>
        {/if}
