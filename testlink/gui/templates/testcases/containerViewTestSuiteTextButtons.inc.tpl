    ...
    <div id="tsuite_control_panel" style="display:{$tlCfg->gui->op_area_display->test_spec_container};">
      <fieldset class="groupBtn">
        ...
        <form method="post" action="{$basehref}lib/testcases/containerEdit.php">
          ...
          {if $tprojIDOK}
            <input type="hidden" name="tpro  ject_id" id="tproject_id" 
      ...
      <fieldset class="groupBtn">
        ...
        <form method="post" action="{$basehref}lib/testcases/containerEdit.php">
		  ...
		  <input type="image" src="{$tlImages.edit}" name="modify_testcases" id="modify_testcases" 
                 onclick="doAction.value='modify_testcases'" title="{$labels.btn_edit_tc}">
