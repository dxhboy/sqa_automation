...
replace_id2name = function(id_string) {
  var post_data = {
    method: 'replace_id2name',
    id2name_string: id_string
  };
...
Setval = function() {
  ...
  //document.getElementById('txta1').innerHTML = belong_to_group;
