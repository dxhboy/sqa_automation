	...
	{ 
		...
		if(task_info_array['taskpicpath']!=null){
			...
			for(j = 0,len=temp.length; j<len; j++) {
				...
				var inndata="<div class='td'><img class='img' src='"+temp[j]+"'/><img style=\"border:none;cursor: pointer; height: 6%;width: 5%;\" title=\"删除图片\" onclick=\"deletepic('"+temp[j].trim().toString()+"','"+task_id+"','"+tempimgname[0]+"');\"src=\"images/delete.jpg\"/></div>";
