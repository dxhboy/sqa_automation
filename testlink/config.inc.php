...
/** text template for a new items:
    Test Case: summary, steps, expected_results, preconditions,notes
...
$tlCfg->testcase_template->notes = new stdClass();
$tlCfg->testcase_template->notes->type = 'none';
$tlCfg->testcase_template->notes->value = '';
