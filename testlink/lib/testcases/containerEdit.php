...
if( isset($_REQUEST['tprojectID']) ) {
  $argsObj->tprojectID = $_REQUEST['tprojectID'];
}
if( isset($_REQUEST['testsuiteID']) ) {
  $argsObj->testsuiteID = $_REQUEST['testsuiteID'];
}
...
function initTPLActions() {
  ...
  $tpl = array( 'move_testsuite_viewer' => 'containerMove.tpl',
				...
				'modify_testcases' =>  'containerModifyTC.tpl',
