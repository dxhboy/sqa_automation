...
// file_put_contents("log.txt", "555555", FILE_APPEND);
// file_put_contents("log.txt", "\n", FILE_APPEND);
// file_put_contents("log.txt", "666", FILE_APPEND);
...
// file_put_contents("log.txt", $gui->tprojects, FILE_APPEND);
// file_put_contents("log.txt", "\n", FILE_APPEND);

$template2launch = $templateCfg->default_template;

// file_put_contents("log.txt", $template2launch, FILE_APPEND);
// file_put_contents("log.txt", "\n", FILE_APPEND);
...
// file_put_contents("log.txt", "\n", FILE_APPEND);
	...
	// file_put_contents("log.txt", $gui->itemQty, FILE_APPEND);
// file_put_contents("log.txt", "\n", FILE_APPEND);
...
// file_put_contents("log.txt", "999", FILE_APPEND);
// file_put_contents("log.txt", $gui->doAction, FILE_APPEND);
// file_put_contents("log.txt", "\n", FILE_APPEND);
...
// file_put_contents("log.txt", $argsObj->userID, FILE_APPEND);
// file_put_contents("log.txt", "\n", FILE_APPEND);
// file_put_contents("log.txt", "opt", FILE_APPEND);
// file_put_contents("log.txt", $opt, FILE_APPEND);
// file_put_contents("log.txt", "\n", FILE_APPEND);
// file_put_contents("log.txt", "filters", FILE_APPEND);
// file_put_contents("log.txt", $_SERVER["QUERY_STRING"], FILE_APPEND);
// file_put_contents("log.txt", "\n", FILE_APPEND);
