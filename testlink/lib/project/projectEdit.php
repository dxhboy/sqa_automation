...
function create(&$argsObj,&$tprojectMgr)
{
  ...
  // file_put_contents("log.txt", "#####is_public", FILE_APPEND);
  // file_put_contents("log.txt", "\n", FILE_APPEND);
// file_put_contents("log.txt", $argsObj->is_public, FILE_APPEND);
// file_put_contents("log.txt", "\n", FILE_APPEND);
// file_put_contents("log.txt", $argsObj->projectOptions, FILE_APPEND);
// file_put_contents("log.txt", "\n", FILE_APPEND);
