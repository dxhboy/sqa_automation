...
$tplEngine->assign('mzftest', 'mzftestvalue');
// console_log($gui);
// console_log(11111);
// console_log($_SERVER);
// console_log(convertUrlQuery($_SERVER["QUERY_STRING"]));

$templateCfg = templateConfiguration();
// console_log($templateCfg);

$param_arr = convertUrlQuery($_SERVER["QUERY_STRING"]);
$type = $param_arr['type'];
// console_log($type);

if ($type == "project_manage_platform") {

	$tplEngine->display('project_management/index.html');
} else {
